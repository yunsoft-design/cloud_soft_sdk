...
from cloud_soft.transition import Transition
        ...
        def get_lst(info):
            ...
            for article in articles['item']:
                article_lst.append({
                    ...
                    'title': Transition.unicode_decode(article['content']['news_item'][0]['title']),
                    'author': Transition.unicode_decode(article['content']['news_item'][0]['author']),
                    'digest': Transition.unicode_decode(article['content']['news_item'][0]['digest']),
                    'content': Transition.unicode_decode(article['content']['news_item'][0]['content']),
